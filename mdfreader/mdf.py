...
class mdf_skeleton(dict):
    ...
    def __init__(self, fileName=None, channelFilter=['.*'], channelList=None, convertAfterRead=True, \
        ...
        self._info = None
        self._noDataLoading = noDataLoading
        # clears class from previous reading and avoid to mess up
        self.clear()
        self.fileName = fileName
        if fileName is not None:
            self.read(fileName, channelFilter=channelFilter, channelList=channelList, convertAfterRead=convertAfterRead, \
