...
class mdf_skeleton(dict):
    ...
    def __init__(self, fileName=None, channelFilter=['.*'], channelList=None, convertAfterRead=True, filterChannelNames=False, noDataLoading=False):
        ...
        if fileName is not None:
            self.read(fileName, channelFilter=channelFilter, channelList=channelList, convertAfterRead=convertAfterRead, filterChannelNames=filterChannelNames, noDataLoading=noDataLoading)
    ...
    def remove_channel(self, channel_name):
        ...
        """
        #print(channel_name, self.getChannelMaster(channel_name))
        #print(self.masterChannelList)
