...
class info3(dict):
        ...
        for dataGroup in range(self['HDBlock']['numberOfDataGroups']):
            ...
            for channelGroup in range(self['DGBlock'][dataGroup]['numberOfChannelGroups']):
                ...
                for channel in range(self['CGBlock'][dataGroup][channelGroup]['numberOfChannels']):
                    ...
                    # Clean signal name
                    shortSignalName = self['CNBlock'][dataGroup][channelGroup][channel]['signalName'].replace(':','')  # short name of signal
                    ...
                    if CNTXpointer > 0:
                        ...
                        longSignalName = longSignalName['Text'].replace(':','')
                    ...
                    deviceName = signalname.split('\\')[-1]
                    if (deviceName != signalname):
                        self['CNBlock'][dataGroup][channelGroup][channel]['deviceName'] = deviceName
    ...
    def listChannels3(self, fileName=None, channelFilter=['.*']):
            ...
            for channelGroup in range(self['DGBlock'][dataGroup]['numberOfChannelGroups']):
                ...
                for channel in range(self['CGBlock'][dataGroup][channelGroup]['numberOfChannels']):
                    ...
                    if addChannel:
                        ...
                        #self['CNBlock'][dataGroup][channelGroup][channel]['signalName'] = signalname.replace(':','')
